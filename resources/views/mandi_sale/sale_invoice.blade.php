...
<div class="container p-0" style="width: 210mm;">
    <div class="row">
        <div class="col-sm-12">
            ...
            <h3 class="text-center pb-">Sale Invoice</h3>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <table rules="all" style="width:100%;border-top: 1px; border-bottom: 1px">
                ...
                <tr>
                    ...
                    <th class="text-center">Mandi Weight</th>
                    <th class="text-center">Mill Weight</th>
...
{{--                    <th class="text-right">Vat%</th>--}}
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{$details->mandi_weight}}</td>
                        <td class="text-center">{{$details->mill_weight}}</td>
                        <td class="text-center">{{$details->remaning_amt}}</td>
